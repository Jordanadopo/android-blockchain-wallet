package com.example.myethwallet;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Build on infura api key below
        web3 = Web3j.build(new HttpService("https://rinkeby.infura.io/v3/acef43eb309040b1b618fd1fdf39589b"));
        ...
        file = new File(getFilesDir() + etheriumwalletPath);// the ethereum wallet location
